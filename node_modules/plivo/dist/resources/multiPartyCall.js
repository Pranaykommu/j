...
exports.MultiPartyCallInterface = exports.MultiPartyCallParticipant = exports.MultiPartyCall = exports.MPCError = undefined;
...
var MultiPartyCall = exports.MultiPartyCall = function (_PlivoResource) {
  ...
  _createClass(MultiPartyCall, [{
    ...
    value: function addParticipant(params) {
      ...
      if (params.ringTimeout || params.ringTimeout === 0) {
        ...
        if (Number.isInteger(params.ringTimeout)) {
          (0, _utils.validRange)('RingTimeout', params.ringTimeout, false, 15, 120);
        } else {
      ...
      if (params.delayDial) {
        ...
        if (Number.isInteger(params.delayDial)) {
          (0, _utils.validRange)('DelayDial', params.delayDial, false, 1, 120);
        } else {
    ...
    value: function start() {
      return _get(MultiPartyCall.prototype.__proto__ || Object.getPrototypeOf(MultiPartyCall.prototype), 'executeAction', this).call(this, this.id + '/', 'POST', { 'status': 'active', 'isVoiceRequest': 'true' });
    }
  }, {
    key: 'stop',
    value: function stop() {
...
var MultiPartyCallInterface = exports.MultiPartyCallInterface = function (_PlivoResourceInterfa) {
  ...
  function MultiPartyCallInterface(client) {
    ...
    var _this4 = _possibleConstructorReturn(this, (MultiPartyCallInterface.__proto__ || Object.getPrototypeOf(MultiPartyCallInterface)).call(this, action, MultiPartyCall, idField, client));
  ...
  _createClass(MultiPartyCallInterface, [{
    ...
    value: function get() {
      ...
      if (uuid) {
        (0, _utils.validParam)('uuid', uuid, [String], false);
      }
      if (friendlyName) {
        (0, _utils.validParam)('friendlyName', friendlyName, [String], false);
      }
      var mpcId = this.makeMpcId(uuid, friendlyName);
    ...
    value: function startParticipantRecording(participantId) {
      ...
      var friendlyName = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : null;
